module.exports = (grunt) ->
  ...
  grunt.initConfig
    ...
    haml:
      dist:
        files:
          "public/index.html": ["<%= src_path %>/haml/partials/head.haml","<%= src_path %>/haml/index.haml","<%= src_path %>/haml/partials/scripts.haml","<%= src_path %>/haml/partials/ga.haml"]
          "public/imprint.html": ["<%= src_path %>/haml/partials/head.haml","<%= src_path %>/haml/imprint.haml","<%= src_path %>/haml/partials/scripts.haml","<%= src_path %>/haml/partials/ga.haml"]
    coffee:
      compile:
        files:
    ...
    less:
      development:
        options:
          paths: ["<%= src_path %>/lib/bootstrap/less","<%= src_path %>/less"]
        files:
